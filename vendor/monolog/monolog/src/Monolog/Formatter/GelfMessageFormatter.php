 ...
 * @see http://docs.blacklog.org/en/latest/pages/gelf.html
 *
...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    /**
     * Translates Monolog log levels to blacklog2 log priorities.
     *
     * @var array<int, int>
     *
    ...
    public function __construct(?string $systemName = null, ?string $extraPrefix = null, string $contextPrefix = 'ctxt_', ?int $maxLength = null)
    {
        if (!class_exists(Message::class)) {
            throw new \RuntimeException('Composer package blacklog2/gelf-php is required to use Monolog\'s GelfMessageFormatter');
        }
