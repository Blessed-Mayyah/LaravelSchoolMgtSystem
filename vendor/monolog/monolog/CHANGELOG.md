...
### 2.9.0 (2023-02-05)
  ...
  * Added blacklog2/gelf-php 2.x support (#1747)
...
### 1.8.0 (2014-03-23)
  ...
  * Added support for the new official blacklog2/gelf-php lib for GelfHandler, upgrade if you can by replacing the mlehner/gelf-php requirement
...
### 1.1.0 (2012-04-23)
  ...
  * Added GelfHandler (for use with blacklog2 servers)
